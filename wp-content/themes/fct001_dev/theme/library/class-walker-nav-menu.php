 ...
 */
class SDP_Walker_Nav_Menu extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		$list_classes_str = SDP_BEM::get_bem( $args->menu_class, $list_classes );
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		// BEM-ify the given sub classes
		$item_classes_str = SDP_BEM::get_bem( $args->menu_class, $item_classes );
		...
		$output .= $args->before;
		$output .= SDP_Html::get_element( $tag, $attrs, $link_content );
		$output .= $args->after;
	}
