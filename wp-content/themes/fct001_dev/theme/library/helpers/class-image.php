...
class SDP_Image {
	...
	public static function get_background( $image, $base_size, $sizes, $attrs = array(), $flags = array() ) {
		...
		$content = SDP_Html::get_element( 'span', array( 'class' => 'visuallyhidden' ), $alt );
		...
		return SDP_Html::get_element( 'span', $bgel_attrs, $content );
	}
	...
	public static function get_picture( $image, $base_size, $sizes, $attrs = array(), $flags = array() ) {
		...
		foreach ( array_reverse( $sizes ) as $size => $query ) {
			...
			$content[] = SDP_Html::get_sc_element( 'source', $source_attrs );
		}
		...
		$content[] = SDP_Html::get_sc_element( 'img', $img_attrs );

		return SDP_Html::get_element( 'picture', null, implode( '', $content ) );
	}
	...
	public static function get_image( $image, $sources, $sizes, $attrs = array(), $flags = array() ) {
		...
		return SDP_Html::get_sc_element( 'img', $img_attrs );
	}
