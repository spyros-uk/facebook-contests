...
class IM_Aggregator {
	...
	// delete old posts
		global $wpdb;
		$wpdb->query("DELETE FROM inc001_posts WHERE post_type = 'sa-socialfeed' AND DATEDIFF(NOW(), post_date) > 10");
