...
function wp_plugin_directory_constants() {
	...
	/**
	 * Allows for the custom-plugins directory to be moved from the default location.
	 *
	 * @since 2.8.0
	 */
	if ( !defined('WPCT_PLUGIN_DIR') )
		define( 'WPCT_PLUGIN_DIR', WP_CONTENT_DIR . '/custom-plugins' ); // full path, no trailing slash
	 ...
	 */
	if ( !defined('WPCT_PLUGIN_DIR') )
		define( 'WPCT_PLUGIN_URL', WP_CONTENT_URL . '/custom-plugins' ); // full url, no trailing slash
	 ...
	 * @deprecated
	 */
	if ( !defined( 'CTPLUGINDIR' ) )
		define( 'CTPLUGINDIR', 'wp-content/custom-plugins' ); // Relative to ABSPATH. For back compat.
}
