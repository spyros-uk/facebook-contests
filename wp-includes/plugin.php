...
function plugin_basename( $file ) {
	...
	$ct_plugin_dir = wp_normalize_path( WPCT_PLUGIN_DIR );

	$file = preg_replace('#^' . preg_quote($plugin_dir, '#') . '/|^' . preg_quote($ct_plugin_dir, '#') . '/#','',$file); // get relative path from plugins dir
	$file = trim($file, '/');
	return $file;
}
 ...
 * @staticvar string $wpct_plugin_path
 *
...
function wp_register_plugin_realpath( $file ) {
	...
	static $wp_plugin_path = null, $wpct_plugin_path = null;
	if ( ! isset( $wp_plugin_path ) ) {
		$wp_plugin_path   = wp_normalize_path( WP_PLUGIN_DIR   );
		$wpct_plugin_path = wp_normalize_path( WPCT_PLUGIN_DIR );
	}

	$plugin_path = wp_normalize_path( dirname( $file ) );
	$plugin_realpath = wp_normalize_path( dirname( realpath( $file ) ) );

	if ( $plugin_path === $wp_plugin_path || $plugin_path === $wpct_plugin_path ) {
		return false;
	}
